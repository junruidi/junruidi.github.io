...
#### 7. Exmaple R codes can be seen [here](https://github.com/junruidi/EM-Algorithm).
...
- If $f_1,f_2, \dots, f_n$ are all convext, then $\text{max}_n\{f_1(x), \dots, f_n(x)\}$ is also convex.
